<?php
    ...
    if(mysqli_num_rows($checkaccountemailq) > 0){
        ...
        if(mysqli_num_rows($checkaccountusernameq) > 0){
            ...
            $insertdata = "INSERT INTO `tbl_userinformation` (`userinfoID`, `fname`, `mname`, `lname`, `birthdate`, `gender`, `email`,`contact`,`address`, `username`, `password`, `status`) VALUES ('$userid', '$fname', '$mname', '$lname', '$bd', '$gender', '$email','$contact','$address', '$username', '$password', '0')";
