    ...
    <div class="col-sm-3">
        <div class="input-group">
            ...
            <select class="form-control" id="filterDropdown">
                <option value="0,1,2,3">Filter By</option>
                <option value="0">Recent</option>
                <option value="1">Last Month</option>
                <option value="2">Earlier this month</option>
                <option value="3">Earlier this year</option>
            </select>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $checkorg = "SELECT *, tbl_users.userid as 'uid'  FROM `tbl_users` INNER JOIN tbl_organization ON tbl_organization.userID = tbl_users.userID INNER JOIN tbl_proofs ON tbl_proofs.proofsID = tbl_organization.proofsID WHERE tbl_users.userlvlID = '2' AND tbl_users.status = '3'";
