            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Organization</h5>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="save-reg-org.php" enctype='multipart/form-data' novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Ogranization Certificate or any proof of stablishing a scholarship</label>
                      <input type="file" name="filesup[]" class="form-control" id="yourEmail" multiple="multiple" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Create Organization</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0"><a href="pages-login.php">Back</a></p>
                    </div>
                  </form>
