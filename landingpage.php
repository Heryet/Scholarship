...
<html lang="en">
    <head>
        ...
        <link href="assets/css/landingstyles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
    ...
    <img src="assets/img/logo.png" alt="">
        <a class="navbar-brand" href="#page-top">DS Scholarship Portal</a>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="signupDropdown">
                        <li><a class="dropdown-item" href="pages-register.php">Student Signup</a></li>
                        <li><a class="dropdown-item" href="org-signup.php">Organization Signup</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Scholarships</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">This portal serves as information website for available scholarships in General Santos City</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Scholarships</h2>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">The developers seeks to create a solution in terms of scholarship applying and renewal fro students and make an easy management system for the organizations</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">This portal serves as the management system for both Applicants and Organization in handling scholarships programs offered in General Santos City</p></div>
                    <div class="col-lg-4 ms-auto"><p class="lead">For any concerns please email us at diversesystem@gmail.com</p></div>
                </div>
        ...
        <!-- Core theme JS-->
        <script src="js/landingscripts.js"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
